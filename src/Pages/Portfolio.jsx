  ...
  return (
    <main className="md:mt-40 mt-28">
      <section className="flex flex-col md:flex-row justify-center md:justify-between md:items-center items-start gap-5 lg:pt-20 lg:pb-28 lg:px-14 md:pt-5 md:pb-20 md:px-10 py-20 px-4">
        <div className="flex-col flex items-start gap-4 md:gap-8">
        <div className="flex md:flex-1 flex-col justify-center md:justify-normal items-start self-stretch md:gap-4 gap-2">
          ...
          <h3 className="font-inter text-2xl md:text-4xl lg:text-5xl font-semibold self-stretch text-[#000]">
            Businesses where our <br className="md:hidden block"/> Digital Solutions <br className="hidden md:block"/>  Made <br className="md:hidden block"/> an Impact
          </h3>
          </div>
        ...
        <Buttons className="py-2 md:py-3 px-4 bg-[#1D5ADD] md:rounded-[0.25rem] rounded-md gap-2 md:self-start self-stretch text-white">
          See Projects
        </Buttons>
        </div>
      ...
      <section className="flex flex-col justify-center items-center py-5 md:py-4 md:px-10 px-4 gap-2 md:self-stretch">
        <span className="font-inter text-xs md:font-bold font-semibold text-[#1D5ADD]">
            SOME OF OUR BEST PROJECTS
        </span>
        <h3 className="font-inter text-2xl md:text-[1.75] font-semibold text-[#242424]">
