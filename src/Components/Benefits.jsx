...
const iconOverlayVariants = {
  ...
  hover: {
    height: "100%",
    transition: { duration: 0.6, ease: easeBounceOut },
  },
  tap: {
    height: "100%",
    transition: { duration: 0.2, ease: easeBounceOut },
  },
};
...
function Benefits({ showAll = false, showSection = false }) {
  ...
  return (
    <>
                  ...
                  (item, index) => {
                    ...
                    return (
                      <motion.article
                        ...
                        whileHover="hover"
                        whileTap="tap"
                        className="group relative flex md:flex-1 md:flex-col flex-row w-full md:items-center items-start self-stretch md:gap-4 gap-2 md:py-6 md:px-4 py-3 px-2 md:self-stretch transition-all duration-600 ease-linear rounded-lg border-[0.4px] md:border border-[#F0F0F0] bg-[#FFF] overflow-hidden hover:border-[1px] hover:border-[#1D5ADD]"
                      >
                        <motion.div
                        ...
                        />
                        <motion.i className="relative overflow-hidden z-0 flex self-stretch md:self-center justify-center p-2 lg:h-14 lg:w-14 md:h-10 md:w-10 h-8 w-8 lg:p-4 bg-[#E8EFFC] items-center lg:gap-[0.41rem] md:gap-1 gap-1 rounded-full">
                          <motion.div
      ...
      {!showSection && (
        <section className="flex items-center self-stretch lg:gap-0 lt:gap-5 gap-5 py-2 px-4 md:p-10 lg:py-16 lg:px-14">
            ...
            <div className="flex flex-col items-start self-stretch gap-2 lg:gap-1">
              <div className="flex flex-col items-start justify-center self-stretch gap-1 md:gap-3">
                ...
                <h3 className="font-inter text-[2rem] text-[#242424] font-semibold self-stretch leading-9">
                  ...
                  <br className="lt:hidden lg:block" /> value.
                </h3>
              </div>
            </div>
