...
function MissionCard() {
  return (
    <main className="grid lt:grid lg:flex lg:flex-col grid-cols-1 lt:grid-cols-2 md:grid-cols-2 justify-center lg:items-start items-center self-stretch lg:gap-6 md:gap-5 gap-4 pt-10 pb-5 md:p-10 px-4 xl:py-16 xl:px-14 ">
        ...
        {missionCard.map((item, index) => {
          ...
          return (
            <motion.article
              ...
              style={item.style}
            >
              <motion.div className="absolute inset-0 z-0 rounded-lg bg-[#E8EFFC]/20 pointer-events-none" />
              <div className="relative z-10 flex flex-grow items-center gap-2">
                ...
                <span className="relative z-10 font-inter text-base md:text-lg font-semibold text-[#565656] transition-all duration-700 mix-blend-difference">
                  {item.title}
                </span>
              </div>
              <p className="relative z-10 flex-grow font-inter text-xs md:text-base transition-all duration-700 self-stretch">
                {item.desc}
              </p>
            </motion.article>
          );
          ...
          return (
            ...
            >
              <div className="relative z-10 flex items-center self-start gap-2">
                ...
                <span className="font-inter text-base md:text-lg font-semibold text-[#565656] transition-all duration-700  mix-blend-difference">
                  {item.title}
                </span>
              </div>
