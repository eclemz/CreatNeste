...
//   return (
//     <main className="flex flex-col justify-center items-start md:py-14 md:px-10 py-6 px-4 gap-6">
...
//             Testimonial
//           </span>
//           <h4 className="font-inter text-xl md:text-3xl font-semibold text-[#242424]">
      ...
      <section className="w-full overflow-x-auto">
        <div className="flex gap-4 snap-x snap-mandatory overflow-x-scroll scrollbar-hide">
          {testimonial.map((item, index) => (
            <div
              key={index}
              className="min-w-[90%] sm:min-w-[48%] lg:min-w-[31%] snap-start bg-white border border-[#EBEBEB] shadow-md rounded-lg px-4 py-6 flex flex-col justify-between"
            >
              <p className="text-[#242424] font-inter text-sm mb-4">
                "{item.desc}"
              </p>
              <div className="flex items-center gap-4">
                <img
